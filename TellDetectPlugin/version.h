...
#define MODULE_FILE_DESC			"Windower plugin for Final Fantasy XIV\0"
#define MODULE_COMPANY_NAME			"North Edge\0"
#define MODULE_COPYRIGHT			"Copyright (C) 2011 North Edge.  All rights reserved.\0"
#define MODULE_PRODUCT_NAME			"x14 Tell detect plugin\0"

#define MODULE_FILENAME				"TellDetect.dll\0"

#define MODULE_PRODUCT_VER_STR		"1, 0, 0, 0\0"
#define MODULE_MAJOR_VERSION		1
#define MODULE_MINOR_VERSION		0
#define MODULE_RELEASE_VERSION		0
#define MODULE_TEST_VERSION			0

#define MODULE_FILE_VER_STR			"1, 0, 0, 0\0"
#define MODULE_PRODUCT_VERSION		"1.0.0.0\0"
